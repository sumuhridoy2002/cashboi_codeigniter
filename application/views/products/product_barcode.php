                  ...
                  <form action="<?php echo base_url().'pBarcode/'.$id; ?>" method="get">
                    <div class="row">
                      <div class="form-group col-md-4 col-sm-4 col-xs-12">
                        <label>Number of Barcode Print *</label>
                        <input type="text" class="form-control" name="nopack" placeholder="Number of Print" required>
                      </div>
                      <div class="form-group col-md-2 col-sm-2 col-xs-12">
                        <button type="submit" name="search" class="btn btn-info" style="margin-top: 30px;"><i class="fa fa-search-plus"></i>&nbsp;Generate Barcode</button>
                      </div>
                    </div>
                  </form>
                </div>
                ...
                <div class="col-sm-12 col-md-12 col-12">
                  <div class="row">
                    ...
                    <div class="col-sm-3 col-md-3 col-12" style="text-align: center;">
                      ...
                      <div class="col-sm-12 col-md-12 col-12">
                        <h3><b>TK. <?php echo number_format($product->sprice, 2); ?></b></h3>
                      </div>
                      <div class="col-sm-12 col-md-12 col-12">
                        <img src="<?php echo base_url().'upload/barcode/'.$barcode; ?>" alt="barcode" style="width: 70%">
                      </div>
                      <div class="col-sm-12 col-md-12 col-12">
                        <h4><b><?php echo $product->productcode; ?></b></h4>
                      </div>
                    </div>
                    <?php } ?>
                  </div>
                    ...
                    <div id="header" style="display: none;">
                      ...
                      <div class="text-center" style="text-align: center; margin-top: 50px; margin-left: 200px; transform: rotate(90deg); page-break-after: always;">
                        <div class="col-sm-12 col-md-12 col-12">
                          <?php
                          $pcode = $product->productcode;
                          $file = Zend_Barcode::draw('code128', 'image', array('text' => $pcode, 'drawText' => FALSE, 'barHeight'=>50, 'factor'=>2), array());
                          $barcode = $pcode.'.png';
                          imagepng($file,"upload/barcode/{$pcode}.png"); ?>
                        </div>
                        <div class="text-center" style="margin-top: 500px;">
                          <div class="col-sm-12 col-md-12 col-12">
                            <img src="<?php echo base_url().'upload/barcode/'.$barcode; ?>"
                                alt="barcode" style="width: 100%;">
                            <h1 style="font-size: 80px;">
                              <b><?php echo $product->productName; ?></b>
                            </h1>               
                            <h1 style="font-size: 80px;">
                              <b><?php echo $product->productcode; ?></b>
                            </h1>
                            <h1 style="font-size: 80px;"><b>TK.
                              <?php echo number_format($product->sprice, 2); ?></b>
                            </h1>
                          </div>
                        </div>
                      </div>
