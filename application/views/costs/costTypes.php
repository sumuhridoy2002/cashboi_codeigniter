                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        ...
                        <a class="btn btn-danger btn-xs" href="<?php echo site_url('Cost/cost_type_delete').'/'.$value->ct_id ?>" onclick="return confirm('Are you sure you want to Delete this Expense Type ?');" ><i class="fa fa-trash"></i></a>
                        <?php } ?> 
                      </td>
                    </tr>   
                    <?php } ?> 
