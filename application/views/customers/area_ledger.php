        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Area Ledger</li>
            </ol>
          </div>
        </div>
      </div>
          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Area Ledger</h3>
              </div>

              <div class="card-body">
                <div class="col-sm-12 col-md-12 col-12">
                  <form action="<?php echo base_url() ?>TRLedger" method="get">
                    <div class="col-md-12 col-sm-12 col-12">
                      <div class="form-group">
                        <b>
                          <input type="radio" name="reports" value="ocust" id="ocust" required >&nbsp;&nbsp;Area All Ledger&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="box-body">
                  ...
                  <?php if(isset($_GET['search'])) { ?>
                    ...
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Area Ledger Reports in : <?php echo $sdate.' - '.$edate; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'monthlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Area Ledger Reports in : <?php echo $name.' '.$year; ?></b></h3>
                    </div>
                    <?php } else if ($report == 'yearlyReports') { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Area Ledger Reports in : <?php echo $year; ?></b></h3>
                    </div>
                    <?php } else { ?>
                    <div class="box-header" style="text-align: center;">
                      <h3 class="box-title"><b>Area Ledger Reports</b></h3>
                    </div>
                    <?php } ?>
                      ...
                      <table id="exam22ple" class="table table-bordered table-striped">
                        ...
                        <tfoot>
                          ...
                          <tr>
                            ...
                            <th><?php echo number_format(($tdu-($tcva+$trpa)), 2); ?></th>
                            <th colspan="3"></th>
                          </tr>
                        </tfoot>
                      </table>
