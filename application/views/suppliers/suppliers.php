              ...
              <div class="card-body table-responsive">
                <table id="example" class="table table-bordered" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><a href="<?php echo site_url('supplierView').'/'.$value['supplierID']; ?>"><?php echo $value['sup_id']; ?></td>
                        ...
                        <div class="input-group input-group-md mb-3">
                          <div class="input-group-prepend">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-item"><a href="<?php echo base_url().'supplierView/'.$value['supplierID']; ?>">
                                    <i class="fa fa-eye"></i> View</a></li>
                              <li class="dropdown-divider"></li>
                                <li class="dropdown-item"><a class="supplier_edit" style="border-color:white; color:#007bff; background-color:transperant;" data-toggle="modal" data-target=".bs-example-modal-supplier_edit" data-id="<?php echo $value['supplierID'];?>" >
                                    <i class="fa fa-edit"></i> Edit</a></li>
                              <li class="dropdown-divider"></li>
                                <li class="dropdown-item"><a href="<?php echo site_url('Supplier/delete_supplier').'/'.$value['supplierID']; ?>" onclick="return confirm('Are you sure you want to Delete this Supplier ?');" >
