                  ...
                  <?php if(isset($_GET['search'])) { ?>
                    <?php if ($report == 'dailyReports') { ?>
                      <div class="box-header" style="text-align: center;">
                        <h4 class="box-title"><b>Supplier Reports in : <?php echo $sdate.' - '.$edate; ?></b></h4>
                      </div>
                    <?php } else if ($report == 'monthlyReports') { ?>
                      <div class="box-header" style="text-align: center;">
                        <h4 class="box-title"><b>Supplier Reports in : <?php echo $name.' '.$year; ?></b></h4>
                      </div>
                    <?php } else if ($report == 'yearlyReports') { ?>
                      <div class="box-header" style="text-align: center;">
                        <h4 class="box-title"><b>Supplier Reports in : <?php echo $year; ?></b></h4>
                      </div>
                    <?php } ?>
                  <?php } ?>    
                  <table id="example" class="table table-bordered" style="width: 100%;" >
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td style="color: red;"><?php echo number_format((($row['balance']+$tpur->dtotal)-$tvpaid->total), 2); $tda += (($row['balance']+$tpur->dtotal)-$tvpaid->total); ?></td>
                      </tr>
                      <?php } ?>
                    </tbody>
                    <tfoot>
