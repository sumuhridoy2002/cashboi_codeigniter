                    ...
                    <?php if(isset($_GET['search'])) { ?>
                      <?php if ($report == 'dailyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h3 class="box-title"><b>Sales Report in : <?php echo $sdate.' - '.$edate; ?></b></h3>
                        </div>
                      <?php } else if ($report == 'monthlyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h3 class="box-title"><b>Sales Report in : <?php echo $name.' '.$year; ?></b></h3>
                        </div>
                      <?php } else if ($report == 'yearlyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h3 class="box-title"><b>Sales Report in : <?php echo $year; ?></b></h3>
                        </div>
                      <?php } ?>
                    <?php } ?>
                    </div>
                      <table id="example" class="table table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $i; ?></td>
                            <td><a target="_blank" href="<?php echo site_url('viewSale').'/'.$sale->saleID ?>"><?php echo $sale->invoice_no; ?></a></td>
                            <td><?php echo date('d-m-Y', strtotime($sale->regdate)); ?></td>
                            <td><?php echo $sale->name; ?></td>
                            <td><?php echo $sale->customerName; ?></td>
                            <td><?php echo number_format($sale->totalAmount+$sale->discountAmount, 2); $ts += $sale->totalAmount+$sale->discountAmount; ?></td>
