                        ...
                        <div class="form-group col-md-4 col-sm-4 col-12">
                            ...
                            <select name="productID" id="products" class="form-control select2" >
                                ...
                                <?php foreach($product as $value): ?>
                                  <option value="<?php echo $value['productID']; ?>"><?php echo $value['productName'].' ('.$value['productcode'].') '.' Stock:'.$value['totalPices'].' '.'| Purchase Price:'.number_format((float)$value['avg_purchase'], 2, '.', '').' '; ?></option>
                                <?php endforeach?>
                            </select>
                        </div>
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type='text' class="form-control" onkeyup='getTotal(<?php echo $value['productID']?>)' id='tp_<?php echo $id; ?>' name='pprice[]' value='<?php echo $value['pprice']?>' required >
                                    </td>
                                    <td>
                                        <input readonly='readonly' type='text' class="tPrice form-control" id='totalPrice_<?php echo $id; ?>' name='total_price[]' value='<?php echo $value['totalPrice']; $ta += $value['totalPrice']; ?>'>
                                    </td>
                                    <td>
