              ...
              <div class="card-body">
                <table id="example" class="table table-bordered" style="width:100%;" >
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?php echo $i; ?></td>
                      <td><a href="<?php echo site_url('viewQuotation').'/'.$id; ?>"><?php echo $value['qinvoice']; ?></a></td>
                      ...
                      <td>
                        <div class="input-group input-group-md mb-3">
                          <div class="input-group-prepend">
                            ...
                            <?php if($_SESSION['view_quotation'] == '1') { ?>
                            ...
                            <?php } if($_SESSION['delete_quotation'] == '1') { ?>
                              <li class="dropdown-item"><a href="<?php echo site_url('Quotation/delete_quotation').'/'.$id; ?>" onclick="return confirm('Are you sure you want to Delete this Quotation ?');" ><i class="fa fa-trash"></i> Delete</a></li>
                            <?php } ?> 
                            </ul>
                          </div>
                        </div>
