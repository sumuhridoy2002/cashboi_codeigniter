        ...
        <div class="row">
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form method="POST" action="<?php echo site_url("Quotation/update_Quotation ") ?>" enctype="multipart/form-data">
                    <input type="hidden" name="qutid" value="<?php echo $quotation['qutid']?>">
                    <div class="row">
                        <div class="form-group col-md-4 col-sm-4 col-12">
                            <label>Quotation Date *</label>
                            <input type="text" name="date" class="form-control datepicker" value="<?php echo date('m/d/Y',strtotime($quotation['quotationDate'])) ?>" required >
                        </div>
                        <div class="form-group col-md-4 col-sm-4 col-12">
                        ...
                        <table id="mtable" class="table table-bordered table-striped">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' class="form-control" id="quantity_<?php echo $value['productID']?>" onkeyup="getTotal('<?php echo $pid?>')" name='quantity[]' value="<?php echo $value['quantity']; ?>">
                                    </td>
                                    <td>
                                        <!--<?php echo $value['salePrice']?>-->
                                        <input type='text' class="form-control" onkeyup='getTotal(<?php echo $value['productID']?>)' id='tp_<?php echo $pid?>' name='tp[]' readonly='readonly' value='<?php echo $value['salePrice']?>' required >
                                    </td>
                                    <td>
                                        <input readonly='readonly' class="form-control" type='text' id='totalPrice_<?php echo $pid?>' name='total_price[]' value='<?php echo $value['totalPrice']?>'>
                                    </td>
                                    <td>
                                        <input type="button" class="btn btn-danger" value="x" onclick='deleteProduct(this)'>
                                    </td>
                                </tr>
                                 <?php endforeach?>
                            </tbody>
                    ...
                    <div class="row" >
                        ...
                        <div class="form-group col-md-8 col-sm-8 col-12">
                          <label>Message </label>                        
                          <input type="text" class="form-control" name="message" placeholder="Message of Quotation" value="<?php echo $quotation['message']; ?>"  >
                        </div>
                        ...
                        <div class="form-group col-md-8 col-sm-12 col-12">
                            <label>File <small style="color: red; font-size:10px">(pdf,doc,png,jpg format allowed)</small></label><br>
