...
public function transfer_account_list()
{
    ...
    // Slice cash data based on pagination
    $data['cash'] = array_slice($data['cash'], $offset, $limit);
...
public function adjustment_list()
{
    ...
    // Count total records
    $total_records = $this->pm->get_data('balance_adjustment', $where);
    ...
    // Fetch adjustment data with pagination
    $other = array(
        'order_by' => 'id'
    );

    $data['adjustment'] = $this->pm->get_data('balance_adjustment', $where, false, false, $other, $limit, $offset);
