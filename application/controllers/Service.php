...
public function service_information()
  {
  $data['title'] = 'Service';
  $swhere = array('compid'=> $_SESSION['compid']);
  $data['service'] = $this->pm->get_data('service_info',$swhere);
...
public function service_sale_info()
  ...
  $data['title'] = 'Service';
  $swhere = array(
      'service_sale.compid'=> $_SESSION['compid']
      );
  $other = array(
    'order_by' => 'ssid',
    'join' => 'left'
  ...
  $data['service'] = $this->pm->get_data('service_sale',$swhere,$field,$join,$other);
    //var_dump($data['purchase']); exit();
...
public function get_Service_Details()
  ...
  foreach($service as $value)
    ...
    <td><span class='item_remove btn btn-danger btn-xs' onclick='deleteProduct(this)'>x</span>
    </td></tr>";
    }
...
public function edit_sale_service($id)
  ...
  $swhere = array('compid'=> $_SESSION['compid']);
  $data['customer'] = $this->pm->get_data('customers',$swhere);
  $data['serviceInfo'] = $this->pm->get_data('service_info',$swhere);
