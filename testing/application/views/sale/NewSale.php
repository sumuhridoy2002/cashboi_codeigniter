      ...
      <div class="modal-dialog modal-sm">
        <div class="modal-content">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
              <input type="text" class="form-control" name="mobile" id="mobile" placeholder="Mobile Number " onkeypress="return isNumberKey(event)" >
            </div>
            <div class="form-group col-md-12 col-sm-12 col-xs-12">
...
<?php $this->load->view('footer/footer'); ?>
 <script type="text/javascript" >
    ...
    //         {
    //         $.ajax({
    //           url: '<?php echo site_url()?>Sale/get_Product_Remove',
    //           async: false,
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#productID').change(function(){ 
          ...
          var base_url = '<?php echo base_url() ?>' + 'Sale/getDetails/'+id;
    ...
    <script type="text/javascript">
      function totalPrice(id)
        ...
        if (parseFloat(pices) > parseFloat(stock)) {
