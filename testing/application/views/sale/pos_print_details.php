    ...
    <div id="wrapper">
        <div id="receiptData">
            ...
            <div id="receipt-data">
                ...
                <p>Payment Mode: <?php echo $sales->accountType; ?><br>Customer:
                    <?php echo $sales->customerName; ?> <br>Mobile:
                    <?php echo $sales->mobile; ?><br>
                ...
                <table class="table table-condensed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom"><?php echo $value->quantity; ?></td>
                            <td class="no-border border-bottom">
                                <?php echo number_format($value->totalPrice, 1); $st += $value->totalPrice; ?></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                    <tfoot>
                        ...
                        <tr>
                            <th colspan="3" class="no-border border-bottom" style="text-align: right;">Discount (-)
                                <?php if($sales->discountType == '%') { ?>(<?php echo $sales->discount; ?>)<?php } ?> :
                            </th>
                            <td class="no-border border-bottom"><?php echo number_format($sales->discountAmount, 2); ?>
                            </td>
                        </tr>
                        <tr>
                            <th colspan="3" class="no-border border-bottom" style="text-align: right;">Total Amount :</th>
                            <td class="no-border border-bottom">
                                <?php echo number_format((($st+$sales->sCost+$sales->vAmount)-$sales->discountAmount), 2); ?>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class="no-border border-bottom">
                                <?php echo number_format((($st+$sales->sCost+$sales->vAmount)-$sales->discountAmount-$sales->paidAmount), 2); ?>
                            </td>
                        </tr>
                    </tfoot>
                </table>
                <p class="text-center">ধন্যবাদ আবার আসবেন @ <?php echo $company->com_name; ?></p>
            </div>
            <div id="buttons" style="padding-top:10px; text-transform:uppercase;" class="no-print">
                ...
                <span class="col-xs-12">
                    <a class="btn btn-block btn-warning" href="<?=base_url('posSales')?>">Back to POS</a>
                </span>
                <div style="clear:both;"></div>
            </div>
        </div>
