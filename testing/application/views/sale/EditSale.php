                        ...
                        <div class="form-group col-md-4 col-sm-4 col-xs-12">
                            ...
                            <select name="productID" id="productID" class="form-control select2">
                                ...
                                <?php foreach($product as $value): ?>
                                  <option value="<?php echo $value['productID']; ?>"><?php echo $value['productName'].' ('.$value['productcode'].') '.' Stock:'.$value['totalPices'].' '.'| Sale Price:'.$value['sprice'].' '; ?></option>
                                <?php endforeach?>
                            </select>
                        </div>
                        ...
                        <table id="mtable" class="table table-bordered table-striped">
                            ...
                            <tbody id="tbody">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type='text' class="form-control" onkeyup='totalPrice(<?php echo $id ?>)' name='pices[]' id='pices_<?php echo $id ?>' value="<?php echo $value['quantity']; ?>">
                                    </td>
                                    <td>
                                        <!--<?php echo $value['sprice']?>-->
                                        <input type='text' class="form-control" onkeyup='totalPrice(<?php echo $id ?>)' name='salePrice[]' id='salePrice_<?php echo $id ?>' value="<?php echo $value['sprice']; ?>" required >
                                    </td>
                                    <td>
                            ...
                            <tfoot>
                              ...
                              <tr>
                                ...
                                <td colspan="2" >
                                  <input type="text" readonly name="due" class="form-control" id="total_remain" value="<?php echo $sale['dueamount']; ?>"  >
                                </td>
                              </tr>
                            </tfoot>
                        </table>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        $('#productID').change(function(){ 
          ...
          var table = 'products';
          var info = {'id':id,'table':table,'custid':custid};
          var base_url = '<?php echo base_url() ?>' + 'Sale/getDetailsAjax/'+id+'/'+custid;
            // alert(base_url);
          $.ajax({
            type: 'POST',
            async: false,
