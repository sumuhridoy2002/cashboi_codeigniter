                ...
                <div class="invoice p-3 mb-3">
                  <div id="print">
                    ...
                    <div class="row" style="padding:10px 20px; ">
                        <div style="margin: 0 0 10px 0;padding:10px 20px; border: 1px solid black;" class="col-sm-12 col-md-12 col-12">
                       <b> Message: </b><?php echo $quotation['message']; ?>
                      </div>
                    </div>
                    <div class="row">
                      <div  class="col-md-12 col-sm-12 col-12">
                    ...
                    <div class="row" id="doc">
                      <div class="col-md-12 col-sm-12 col-12" >
                          <?php if($quotation['file']){ ?>
                        <div class="form-group col-md-12 col-sm-12 col-12">
                         <b> Attached file:</b>
                        </div>
                        
                        <div class="form-group col-md-12 col-sm-12 col-xs-12">
                          <a href="<?php echo site_url('./upload/quotation').'/'.$quotation['file']; ?>"
                                                class="btn btn-sm"
                                                style="background-color: #00f169; color: black;"  target="_blank">
                                                <i class="fa fa-eye"></i>
                                            </a>
                        </div>
                        <?php } ?>
