          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="card">
              ...
              <div class="card-body" style="text-transform:uppercase;">
                <form method="POST" action="<?php echo site_url("Quotation/save_quotation") ?>" enctype="multipart/form-data">
                  <div class="row">
                    ...
                    <div class="form-group col-md-8 col-sm-8 col-12">
                      <label>Message </label>                        
                      <input type="text" class="form-control" name="message" placeholder="Message of Quotation" >
                    </div>
