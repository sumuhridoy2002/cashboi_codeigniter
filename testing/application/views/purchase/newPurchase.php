                    ...
                    <div class="row">
                      ...
                      <div class="form-group col-md-4 col-sm-4 col-12">
                        ...
                        <div class="input-group">
                          ...
                          <span class="input-group-append" style="margin-left:-31px;">
                            <button type="button" class="btn btn-danger btn-sm supplier_add" data-toggle="modal" data-target=".bs-example-modal-supplier_add" style="position: absolute; height: -webkit-fill-available;"><i class="fa fa-plus"></i></button>
                          </span>
                        </div>
                      </div>
                      <div class="form-group col-md-4 col-sm-4 col-12">
                        ...
                        <div class="input-group input-group-sm">
                          ...
                          <span class="input-group-append" style="margin-left:-30px;">
                            <button type="button" class="btn btn-danger btn-sm product" data-toggle="modal" data-target=".bs-example-modal-product" style="position: absolute; height: -webkit-fill-available;" ><i class="fa fa-plus"></i></button>
                          </span>
                        </div>
                        ...
                        <table id="mtable" class="table table-bordered table-striped">
                          ...
                          <tfoot>
                            ...
                            <tr>
                              ...
                              <td colspan="2">
                                <input type="text" class="form-control" name="Paid" onkeyup="calculate_remain()" id="Paid" value="0" required >
                              </td>
                            </tr>
                            <tr style="color: red;">
        ...
        <div class="modal-content">
          ...
          <div class="col-md-12 col-sm-12 col-12">
            <div class="row">
              ...
              <div class="form-group col-md-6 col-sm-6 col-12">
                  ...
                  <input type="text" class="form-control" name="alertqty" id="alertqty" placeholder="Alert Quantity">
                </div>
          ...
          <div class="row">
            <div class="form-group col-md-6 col-sm-6 col-12">
              ...
              <textarea type="text" class="form-control" name="details" id="details" rows="2" ></textarea>
            </div>
            <div class="form-group col-md-6 col-sm-6 col-12">
              <label>Product Specification (Optional)</label>
              <textarea type="text" class="form-control" name="specification" id="specification" rows="2" ></textarea>
            </div>
          </div>
          </div>
          <div class="modal-footer">
...
<?php $this->load->view('footer/footer'); ?>
    ...
    <script type="text/javascript" >
      $(function(){
          ...
          $.ajax({
            ...
            //alert(data);
              ...
              for (var key in data) 
                ...
                if (data.hasOwnProperty(key))
                  {
                  HTML +="<option value='"+data[key]["productID"]+"'>" + data[key]["productName"]+' ( '+ data[key]["productcode"]+' )'+' | Stock: '+ data[key]["totalPices"]+' '+'| Purchase Price(Avg): '+ data[key]["avg_purchase"]+' '+"</option>";
                  }
                }
              $("#products").html(HTML);
              },
        ...
        $("#psubmit").click(function(){
          ...
          '&scategory='+ scategory + '&brand='+ brand + '&alertqty='+ alertqty + '&details='+ details + '&specification='+ specification;
          // AJAX Code To Submit Form.
          $.ajax({
            type: "POST",
    ...
    <script type="text/javascript">
      function getTotal(id)
        ...
        // {
        //     $.ajax({
        //       url: '<?php echo site_url()?>Purchase/get_Product_Remove',
        //       async: false,
