                  ...
                  <div id="print">
                    <div class="row" id="header" style="display: none" >
                      ...
                      <div class="col-sm-8 col-md-8 col-8 text-right">
                        ...
                        <!--<div class="col-sm-12 col-md-12 col-12">-->
                        <!--  <b><h3>Purchase Report</h3></b>-->
                        <!--</div>-->
                      </div>
                      <?php } ?>
                    </div><hr>
                    <div class="col-sm-12 col-md-12 col-12" style="color: #0f307a;">
                    <?php if(isset($_GET['search'])) { ?>
                      <?php if ($report == 'dailyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h4 class="box-title"><b>Purchase Reports in : <?php echo $sdate.' - '.$edate; ?></b></h4>
                        </div>
                      <?php } else if ($report == 'monthlyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h4 class="box-title"><b>Purchase Reports in : <?php echo $name.' '.$year; ?></b></h4>
                        </div>
                      <?php } else if ($report == 'yearlyReports') { ?>
                        <div class="box-header" style="text-align: center;">
                          <h4 class="box-title"><b>Purchase Reports in : <?php echo $year; ?></b></h4>
                        </div>
                      <?php } ?>
                    <?php } ?>
                    </div>
                    <div class="col-sm-12 col-md-12 col-12 table-responsive">
                      <table <?php if(!isset($_GET['search'])){ ?>id="example" <?php } ?> class="table table-bordered table-hover" >
                        <thead>
                          <tr>
