                      ...
                      <table id="example" class="table table-responsive table-bordered table-hover" >
                        ...
                        <tbody>
                          ...
                          <tr class="gradeX">
                            ...
                            <td style="color:red;"><?php echo number_format(($value->totalPrice)-($value->paidPrice), 2); ?></td> 
                          </tr>   
                          <?php } ?> 
                          <?php } else{ ?>
                          <?php $u = 0; ?>
                          ...
                          <tr class="gradeX">
                            ...
                            <td><?php echo number_format(($value->totalPrice), 2); ?></td> 
                            <td><?php echo number_format(($value->paidAmount), 2); ?></td> 
                            <td style="color:red;"><?php echo number_format(($value->totalPrice-$value->paidAmount), 2); ?></td> 
                          ...
                          <tr class="gradeX">
                            ...
                            <td><?php echo number_format(($value->totalamount), 2); $tvpa += $value->totalamount; ?></td> 
                            <td style="color:red;"><?php echo '0.00'; ?></td>
                          </tr>   
                          <?php } ?>
                          <?php } else{?>
                          <?php $m=0;?>
                          ...
                          <tr class="gradeX">
                            ...
                            <td><?php echo 'EMP-00'.$value->empPid; ?></td>
                            <td><?php echo number_format(($value->salary), 2); $tvpa += $value->salary; ?></td> 
                            <td><?php echo number_format(($value->paid), 2); $tvpa += $value->paid; ?></td> 
                            <td style="color:red;"><?php echo number_format(($value->salary)-($value->paid), 2); ?></td>
                          </tr>   
                          <?php } ?>
                          <?php } ?>
