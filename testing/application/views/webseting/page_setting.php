              ...
              <div class="card-body">
                ...
                <div class="col-md-12 col-sm-12 col-12">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="form-control" name="pContent" id="editor" placeholder="Page Content" rows="6" required ><?php if($pageSetup){ ?><?php echo $pageSetup[0]['pContent']; ?><?php } ?></textarea>
                  </div>
                </div>
