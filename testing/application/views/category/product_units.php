                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">      
                      ...
                      <td>
                        ...
                        <a class="btn btn-danger btn-xs" href="<?php echo site_url('Category/delete_units').'/'.$value->id; ?>" onclick="return confirm('Are you sure you want to Delete this Unit ?');" ><i class="fa fa-trash"></i></a>
                        <?php } ?>
                      </td>
                    </tr>   
                    <?php } ?> 
