            ...
            $('.category_edit').click(function(){
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        // Set the selected category in the dropdown by both value and text
                        $("#category").val(HTML).trigger('change'); // Set the value
                        $("#category option:selected").text(HTML2); // Set the text
