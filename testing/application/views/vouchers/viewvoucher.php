                  ...
                  <div class="col-sm-12 col-md-12 col-12">
                   ...
                   <?php
                    $i = 0;
                            ...
                            $i++;
                   $supplier = $this->db->select('supplierName')->from('suppliers')->where('supplierID',$value['vutid'])->get()->row();
                   ...
                   $customer = $this->db->select('customerName')->from('customers')->where('customerID',$value['vutid'])->get()->row();
                   ...
                   ?>
                       ...
                       <div class="row">
                                <div class="col-sm-12 col-md-12 col-xs-12" style="display:flex; font-size:1.2rem;">
                                    <div class="col-sm-4 col-md-4 col-xs-4">
                                        <b>No:</b> <?php echo $voucher['invoice']; ?><br>
                                     <?php if($voucher['vauchertype']=='Credit Voucher'){ ?>   
                                     <b>Received From:</b> <?php echo $cname; }?>
                                    ...
                                    <div class="col-sm-4 col-md-4 col-xs-4" style="text-align:center;">
                                        <span class="receipt" style="background-color: black !important;color:white;padding: 7px;border-radius: 22px;font-size: 25px;font-weight: 500;"><?php echo $str; ?></span>
                                    </div>
                        ...
                        <table class="table table-bordered table-striped">
                         <?php    if($voucher['vauchertype']=='Debit Voucher'){ ?>
                          ...
                          <tbody>
                            ...
                            foreach ($voucherp as $value) {
                            $i++;
                            $cost = $this->db->select('costName')->from('cost_type')->where('ct_id',$value['vutid'])->get()->row();
                            if($cost)
                                {
                          ...
                          <tbody style="">
                            <tr style="text-align: center; background-color: #fff; color: #000;">
                                ...
                                <td colspan="3" style="text-align: left;">( In Words&nbsp;&nbsp;:&nbsp;&nbsp;<?php echo convertNumber($twa); ?> )</td>
                            </tr>
                          </tbody>
                        <?php } 
                        else { ?>
