                      ...
                      <table class="table table-bordered" >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo number_format(($cpreturn->total), 2); ?></td>
                            <td>4</td>
                            <td>Employee Payments</td>
                            <td><?php echo number_format($cempp->paid, 2); ?></td>
                          </tr>
                          <tr>
                            <td>5</td>
                            <td>Service Sale</td>
                            <td><?php echo number_format(($cservice->total), 2); ?></td>
                            <td>5</td>
                            <td>Sale Returns</td>
                          ...
                          <tr>
                            ...
                            <td>
                              <?php $ti = $csale->total+$ccvoucher->total+$pamount+$cpreturn->total+$cservice->total; ?>
                              <b><?php echo number_format($ti, 2); ?></b>
                            </td>
                            <td colspan="2" style="text-align: center;"><b>Today Total Expense</b></td>
                            <td>
                              <?php $te = $cpurchase->total+$cdvoucher->total+$csvoucher->total+$cempp->paid+$creturn->total; ?>
