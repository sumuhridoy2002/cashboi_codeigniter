                        ...
                        <div class="card-body" style="text-transform:uppercase;">
                            <form method="POST" action="<?php echo site_url("Voucher/save_voucher") ?>">
                                <div class="col-md-12 col-sm-12 col-12">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-8 col-sm-8 col-12">
                                            ...
                                            <div style="text-transform:capitalize;">
                                                <input type="radio" name="vaucher" value="Credit Voucher" id="credit"
                                                    required>&nbsp;&nbsp;Income Voucher&nbsp;&nbsp;
                                                <input type="radio" name="vaucher" value="Debit Voucher" id="debit"
                                                    required>&nbsp;&nbsp;Expense Voucher&nbsp;&nbsp;
                                                <!-- <input type="radio" name="vaucher" value="Customer Pay" id="customerPay" required >&nbsp;&nbsp;Customer Pay&nbsp;&nbsp; -->
                                                <input type="radio" name="vaucher" value="Supplier Pay" id="supplierPay"
                                                    required>&nbsp;&nbsp;Supplier Pay
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-none col-md-12 col-sm-12 col-xs-12" id="employee">
                                        <div class="form-group col-md-12 col-sm-12 col-12">
                                            ...
                                            <div>
                                                ...
                                                <span class="input-group-append">
                                                    <button type="button" class="btn btn-danger btn-sm costType"
                                                        data-toggle="modal"
                                                        data-target=".bs-example-modal-costType"><i
                                    ...
                                    <div class="d-none col-md-12 col-sm-12 col-xs-12" id="supplier">
                                        <div class="form-group col-md-12 col-sm-12 col-12">
                                            ...
                                            <!--</select>-->
                                            <div>
                                                <select name="supplier" id="supplierID" class="form-control select2"
                                                    required="">
                                                    <option value="">Select One</option>
                                                </select>
                                                <span class="input-group-append">
                                                    <button type="button" class="btn btn-danger btn-sm supplier_add"
                                                        data-toggle="modal" data-target=".bs-example-modal-supplier_add"><i class="fa fa-plus"></i></button>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group col-md-12 col-sm-12 col-xs-12"
                                        ...
                                        <a href="<?php echo site_url('Voucher') ?>" class="btn btn-danger"><i
                            ...
                            <div class="d-none col-md-12 col-sm-12 col-xs-12">
                                <div id="product">
                                    <ol class="ct">
                                        <div class="row"
                                            style="background-color:#c5c745; border-radius: 4px; border:1px solid #fff; color: black; margin-left: -90px;">
                                            <div class="form-group col-md-6 col-sm-6 col-6">
                                                <label>Particulars</label>
                                                <input type="text" name="particular[]" placeholder="Particulars"
                                                    class="form-control">
                                            </div>
                                            <div class="form-group col-md-4 col-sm-4 col-4">
                                                <label>Amount</label>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                        ...
                        <input type="text" class="form-control" name="balance" id="balance"
                            onkeypress="return isNumberKey(event)" placeholder="Amount">
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                success: function(data) {
                    ...
                    for (var key in data) {
                        if (data.hasOwnProperty(key)) {
                            HTML += "<option value='" + data[key]["ct_id"] + "'>" + data[key][
                                "costName"
                            ] + "</option>";
                        }
                    }
...
<script type="text/javascript">
    $(function() {
        ...
        function load_suppliers() {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    for (var key in data) {
                        if (data.hasOwnProperty(key)) {
                            HTML += "<option value='" + data[key]["supplierID"] + "'>" + data[key][
                                "supplierName"
                            ] + ' ( ' + data[key]["sup_id"] + ' )' + "</option>";
                        }
                    }
        ...
        $("#pbsubmit").click(function() {
            ...
            var address = $("#address").val();
            var balance = $("#balance").val();
            var dataString = 'supplierName=' + supplierName + '&compname=' + compname + '&mobile=' +
                mobile + '&email=' + email + '&address=' + address + '&balance=' + balance;
            // AJAX Code To Submit Form.
            $.ajax({
                type: "POST",
