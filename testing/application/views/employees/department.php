                  ...
                  <tbody>
                    ...
                    <tr class="gradeX">
                      ...
                      <td>
                        ...
                        <a class=" btn btn-danger btn-xs" href="<?php echo site_url('employee/delete_dept').'/'.$value['dpt_id'] ?>" onclick="return confirm('Are you sure you want to Delete this Department ?');" ><i class="fa fa-trash"></i></a>
                      </td>
                    </tr>   
                    <?php } ?> 
                  </tbody>
